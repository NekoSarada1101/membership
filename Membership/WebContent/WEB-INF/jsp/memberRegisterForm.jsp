...
<form action="Register" method="post">
    ...
    <div class="group col-8">
        ...
        <div class="input-group input-group-lg">
            <input type="text" class="form-control" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-lg" name="id" placeholder="1" pattern="[0-9]" title="数字のみで入力してください" autofocus required>
        </div>
    </div>
    <div class="group col-8">
        <h4>Name</h4>
    ...
    <div class="group col-8">
        ...
        <div class="input-group input-group-lg">
            <input type="text" class="form-control" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-lg" name="addr" placeholder="東京都" list="prefectures" required>
